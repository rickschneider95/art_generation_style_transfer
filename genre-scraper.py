...
parser.add_argument("--output_dir", help="where to put output files", default='./images/test')

# to run in terminal:
#  python3 genre-scraper.py --genre landscape --style neo-pop-art --num_pages 1
# this will output in the images/test folder
